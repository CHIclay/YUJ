<%@ Page Title="" Language="C#" MasterPageFile="~/WebPage.Master" AutoEventWireup="true" CodeBehind="shudanxxx.aspx.cs" Inherits="WebApplication1.shudanxxx" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       <div id="contentpage">
           <a href="shudan.aspx">返回书单界面</a><br /><br />
 ...
 <br /><div style="float:right;">书单创建时间：<asp:Label ID="Label3" runat="server" style="height:50px;width:200px;" Text='<%#Eval ("list1_time") %>'/></div>
...
<%--                                   <div> <asp:HyperLink  ID="btnDelete" runat="server" Text="删除" NavigateUrl='<%#"~/Admin_YUJIAN/Admin_shudanxx.aspx?list_book_keep_id=&list1_name="+ Eval("list_book_keep_id")+ Eval("list1_name")%>' OnClientClick="return confirm('确认删除？')" Height="25px" Font-Size="12px" /> </div>--%>
                                    <span style="float:right;padding-left:600px;"> <asp:HyperLink  ID="HyperLink1" runat="server" Text="删除" NavigateUrl='<%#"~/Admin_YUJIAN/Admin_shudanxx.aspx?list_book_keep_id="+Eval("list_book_keep_id")+"&list1_name="+Eval("list1_name")%>' OnClientClick="return confirm('确认删除？')" Height="25px" Font-Size="12px" /> </span>
